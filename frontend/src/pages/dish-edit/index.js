...
const DishEdit = ({ onEdit }) => {
  ...
  const handleSubmit = (e) => {
    ...
    api.updateDish(id, formData).then((dish) => {
    ...
    <Main>
      <Container>
        <MetaTags>
          ...
          <meta name="description" content="Фудграм - Редактирование блюда" />
          <meta property="og:title" content="Редактирование блюда" />
        </MetaTags>
        <Title title="Редактирование блюда" />
        <Form
